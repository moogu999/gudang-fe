...
export default {
  ...
  customers: {
    ...
    labels: {
      ...
      selectOutletType: 'Select Customer Type',
    ...
    validation: {
      codeRequired: 'Code is required.',
      nameRequired: 'Name is required.',
      outletTypeRequired: 'Customer type is required.',
  ...
  chartOfAccounts: {
    ...
    labels: {
      header: 'Header (grouping only)',
      detail: 'Detail (postable)',
      debit: 'Debit',
      credit: 'Credit',
      level: 'New account level: {level}',
      ...
      selectControlAccountType: 'Select Control Account Type',
      noParent: 'No parent (top-level account)',
    },
    helpers: {
      uniqueCode: 'Must be unique across the entire Chart of Accounts',
      autoNormalBalance: 'Auto-set from the account type, override manually for special cases',
      controlAccount: 'Links this account to a subledger (AR, AP, or Inventory)',
      retainedEarnings: 'Only one account per company can be the retained earnings account',
    },
    warnings: {
      detailParent: 'New accounts should sit under a Header account to keep the hierarchy clean.',
      accountInUse:
        'This account already has journal entries. Code, Type, and Normal Balance can no longer be changed.',
    },
    validation: {
      codeRequired: 'Code is required.',
      nameRequired: 'Name is required.',
      accountTypeRequired: 'Account type is required.',
      controlAccountTypeRequired: 'Control account type is required.',
    },
    messages: {
  ...
  accountingPeriods: {
    ...
    actions: {
      open: 'Open period',
      close: 'Close period',
      requestReopen: 'Request reopen',
      permanentClose: 'Close permanently',
      revertPermanentClose: 'Revert permanent close',
    },
    labels: {
      addRow: 'Add Row',
      removeRow: 'Remove Row',
      prefillMonthly: 'Prefill from Monthly',
      periodsWillBeCreated: '{n} periods will be created',
      noActivity: 'No activity yet',
      legend: 'Status legend',
      reopenPending: 'Reopen pending approval',
      selectReopenFlow: 'Select an approval flow',
      historyOpened: 'Opened {date}',
      historyClosed: 'Closed {date}',
      historyPermanentlyClosed: 'Permanently closed {date}',
      historyReverted: 'Reverted {date} — {reason}',
    },
    helpers: {
      monthlyPreview: 'Preview of the periods that will be generated',
      customEditor:
        'Define each period manually — they must exactly tile the fiscal year with no gaps or overlaps.',
      frozen:
    ...
    warnings: {
      ...
      confirmCheckbox: 'I confirm this action.',
    },
    validation: {
      nameRequired: 'Name is required.',
      startDateRequired: 'Start date is required.',
      ...
      gap: 'Gap between {after} and {before}.',
      overlap: 'Overlaps the previous period ({after} to {before}).',
  ...
  accountingPeriodConfigs: {
    title: 'Accounting Period Configs',
    ...
    labels: {
      selectCompany: 'Select Company',
      selectCompanyFirst: 'Select a company to see its config.',
  ...
  goodsReceipts: {
    ...
    details: {
      ...
      quantity: 'Qty',
      poQuantity: 'Qty PO',
      remainingQuantity: 'Qty Remaining',
  ...
  apInvoices: {
    title: 'AP Invoices',
    addApInvoice: 'Add AP Invoice',
    viewApInvoice: 'AP Invoice Detail',
    codeMode: {
      auto: 'Auto',
      manual: 'Manual',
      assignedOnSave: 'Assigned on save',
    ...
    sections: {
      ...
      invoiceInfo: 'Invoice & Payment',
      coveredReceipts: 'Covered Goods Receipts',
      summary: 'Summary',
    },
    labels: {
    ...
    picker: {
      title: 'Invoiceable Goods Receipts',
      searchPlaceholder: 'Search receipt or PO number',
      addSelected: 'Add Selected',
      addAll: 'Add All on Page',
      selectSupplierFirst: 'Choose a supplier to see its invoiceable goods receipts.',
      receiptNo: 'Goods Receipt',
      ref: 'Ref',
      receiptDate: 'Receipt Date',
      warehouse: 'Warehouse',
      value: 'Receipt Value',
      selectedCount: '{count} receipts selected',
      selectedTotal: 'Total value: {amount}',
    },
    coveredReceipts: {
      empty: 'No goods receipts attached yet.',
    ...
    actions: {
      saveAsDraft: 'Save as Draft',
      submitForApproval: 'Submit for Approval',
      editApInvoice: 'Edit AP Invoice',
    },
    confirm: {
      header: 'Confirm Submission',
      message: 'This will submit the AP invoice for approval. Continue?',
    },
    validation: {
      noRequired: 'Invoice number is required.',
      supplierRequired: 'Supplier is required.',
      supplierInvoiceNoRequired: 'Supplier invoice number is required.',
    ...
    messages: {
      ...
      updated: 'AP invoice updated successfully.',
  ...
  apInvoiceConfigs: {
    ...
    labels: {
      ...
      noApprovalRequired: 'No approval required',
      approvalConfigured: 'Approval configured',
      approvalFlowHint: 'Leave empty if AP invoices from this branch do not need approval.',
    },
    validation: {
      branchRequired: 'Branch is required.',
    },
  ...
  arClearings: {
    title: 'AR Clearing',
    addArClearing: 'Add AR Clearing',
    viewArClearing: 'AR Clearing Detail',
    codeMode: {
      auto: 'Auto',
      manual: 'Manual',
      assignedOnSave: 'Assigned on save',
    ...
    fields: {
      ...
      customer: 'Customer',
      selectCustomer: 'Select a customer',
      customerHint: 'Changing the customer clears the ticked cash and every allocation below.',
      remark: 'Remark',
    },
    sections: {
      header: 'Clearing Information',
      sources: 'Cash Available',
    ...
    invoices: {
      selectCustomerFirst: 'Select a customer to see its outstanding invoices.',
      invoiceNo: 'Invoice',
      age: 'Age',
      ageDays: '{days} days',
      aging: {
        ok: 'Up to 14 days',
        warn: '15 to 59 days',
        danger: '60 days or more',
      },
      total: 'Total',
      outstanding: 'Outstanding',
      outstandingNow: 'Outstanding Now',
      allocation: 'Allocation',
      empty: 'This customer has no outstanding invoices.',
      autoAllocate: 'Auto-allocate FIFO',
    },
    allocation: {
      none: 'Unallocated',
      partial: 'Partial',
    ...
    summary: {
      available: 'Total Cash Available',
      allocated: 'Total Allocated',
      unallocated: 'Unallocated',
      remainderHint:
        "This does not have to be fully allocated. The remainder stays available for this customer's next clearing.",
    },
    status: {
      draft: 'Draft',
      completed: 'Completed',
    ...
    actions: {
      saveDraft: 'Save as Draft',
      submit: 'Submit Clearing',
      void: 'Void',
      editArClearing: 'Edit AR Clearing',
    },
    confirm: {
      header: 'Confirm',
      submit:
        "Apply {total} to {customer}'s invoices? A completed clearing can only be voided, not edited.",
      autoAllocate: 'This replaces the allocations you have already entered. Continue?',
      void: 'Voiding reverses every invoice and cash line this clearing applied. This cannot be undone.',
    },
    void: {
      title: 'Void AR Clearing',
      reason: 'Reason',
      reasonRequired: 'A reason is required to void.',
      voidedBanner: 'This clearing has been voided.',
    },
    validation: {
      noRequired: 'Clearing number is required.',
      customerRequired: 'Customer is required.',
      branchRequired: 'Branch is required.',
      clearingDateRequired: 'Clearing date is required.',
      noSources: 'Tick at least one cash line.',
      noAllocations: 'Allocate an amount to at least one invoice.',
      insufficientCash: 'The allocations exceed the cash available. Reduce them or tick more cash.',
    },
    messages: {
      created: 'AR clearing saved successfully.',
      updated: 'AR clearing updated successfully.',
      deleted: 'AR clearing deleted successfully.',
      voided: 'AR clearing voided successfully.',
      notFound: 'AR clearing not found.',
  ...
  deliveryNotes: {
    ...
    addedDos: {
      ...
      summaryDo: '{count} DO',
      summaryCustomers: '{count} customer(s)',
