...
export default {
  ...
  customers: {
    ...
    labels: {
      ...
      selectOutletType: 'Pilih Tipe Pelanggan',
    ...
    validation: {
      codeRequired: 'Kode wajib diisi.',
      nameRequired: 'Nama wajib diisi.',
      outletTypeRequired: 'Tipe pelanggan wajib diisi.',
  ...
  paymentTerms: {
    ...
    addPaymentTerm: 'Tambah Termin Pembayaran',
    editPaymentTerm: 'Edit Termin Pembayaran',
    viewPaymentTerm: 'Lihat Termin Pembayaran',
    deletePaymentTerm: 'Hapus Termin Pembayaran',
    fields: {
      days: 'Jumlah Hari',
    },
    validation: {
    ...
    messages: {
      paymentTermCreated: 'Termin pembayaran berhasil dibuat.',
  ...
  suppliers: {
    ...
    labels: {
      selectPaymentTerm: 'Pilih Termin Pembayaran',
    },
    codeMode: {
      auto: 'Otomatis',
      manual: 'Manual',
    ...
    validation: {
      ...
      picPhoneRequired: 'No. HP PIC wajib diisi.',
      paymentTermRequired: 'Termin pembayaran wajib diisi.',
    },
    messages: {
      supplierCreated: 'Pemasok berhasil dibuat.',
  ...
  chartOfAccounts: {
    ...
    fields: {
      ...
      retainedEarnings: 'Akun Laba Ditahan',
      status: 'Status Akun',
      flags: 'Flag',
    },
    labels: {
      header: 'Header (hanya pengelompokan)',
      detail: 'Detail (bisa diposting)',
      debit: 'Debit',
      credit: 'Kredit',
      level: 'Level akun baru: {level}',
      collapseAll: 'Tutup Semua',
      expandAll: 'Buka Semua',
      showInactive: 'Tampilkan Non-aktif',
      all: 'Semua',
      selectCompany: 'Pilih Perusahaan',
      selectAccountType: 'Pilih Tipe Akun',
      selectControlAccountType: 'Pilih Jenis Control Account',
      noParent: 'Tanpa induk (akun level teratas)',
    },
    helpers: {
      uniqueCode: 'Harus unik di seluruh Bagan Akun',
      autoNormalBalance: 'Auto-set dari tipe akun, override manual bila ada kasus khusus',
      controlAccount: 'Menautkan akun ini ke subledger (AR, AP, atau Inventory)',
      retainedEarnings: 'Hanya satu akun per perusahaan yang boleh menjadi akun laba ditahan',
    },
    warnings: {
      detailParent: 'Akun baru sebaiknya di bawah Header agar hierarchy tetap bersih.',
      accountInUse:
        'Akun ini sudah memiliki jurnal transaksi. Kode, Tipe, dan Saldo Normal tidak dapat diubah lagi.',
    },
    validation: {
      codeRequired: 'Kode akun wajib diisi.',
      nameRequired: 'Nama akun wajib diisi.',
      accountTypeRequired: 'Tipe akun wajib diisi.',
      controlAccountTypeRequired: 'Jenis control account wajib diisi.',
    },
    messages: {
  ...
  cashDeposits: {
    ...
    picker: {
      ...
      search: 'Cari nomor invoice atau pelanggan',
  ...
  bankSettlements: {
    title: 'Penyelesaian Bank',
    addBankSettlement: 'Tambah Penyelesaian Bank',
    viewBankSettlement: 'Detail Penyelesaian Bank',
    codeMode: {
      auto: 'Otomatis',
      manual: 'Manual',
      assignedOnSave: 'Diberikan saat disimpan',
    ...
    sections: {
      header: 'Informasi Penyelesaian',
      mutations: 'Mutasi Kredit',
      summary: 'Ringkasan',
    },
    table: {
      mutationDate: 'Tanggal',
      description: 'Keterangan Bank',
      amount: 'Nominal',
      customer: 'Pelanggan',
      status: 'Status',
      tagged: 'Ter-tag',
      untagged: 'Belum ter-tag',
      addRow: 'Tambah Baris',
      removeRow: 'Hapus baris',
      selectCustomer: 'Pilih pelanggan',
      empty: 'Belum ada mutasi kredit.',
      nameMismatchHint:
    ...
    labels: {
      ...
      companyUnresolved:
        'Cabang ini belum dipetakan ke perusahaan. Petakan di Perusahaan → Cabang sebelum menyimpan.',
      splitHint:
        'Baris yang belum ter-tag boleh dibiarkan untuk nanti. Saat disubmit, baris tersebut dipindahkan ke draf baru dan penyelesaian ini hanya menyimpan baris yang ter-tag.',
      splitFrom: 'Dipecah dari {no}',
      submitDisabledHint: 'Tag minimal satu baris untuk submit.',
    },
    status: {
      draft: 'Draf',
      completed: 'Selesai',
    ...
    actions: {
      saveAsDraft: 'Simpan sebagai Draf',
      submit: 'Submit',
      editBankSettlement: 'Ubah Penyelesaian Bank',
      openRemainder: 'Buka Draf Baru',
      backToList: 'Kembali ke Daftar',
    },
    confirm: {
      header: 'Konfirmasi',
      messageComplete: 'Penyelesaian bank akan diselesaikan. Lanjutkan?',
      messageSplit: '{count} baris belum ter-tag dan akan dipindahkan ke draf baru. Lanjutkan?',
    },
    validation: {
      noRequired: 'Nomor penyelesaian wajib diisi.',
      bankAccountRequired: 'Rekening bank wajib diisi.',
      periodRequired: 'Pilih periode rekening koran (tanggal awal dan akhir).',
      branchRequired: 'Cabang wajib diisi.',
      noLines: 'Tambahkan minimal satu mutasi kredit.',
      noTaggedLines: 'Tag minimal satu baris untuk submit.',
      linesInvalid: 'Perbaiki baris mutasi yang ditandai.',
      lineDateRequired: 'Tanggal wajib diisi.',
    ...
    messages: {
      ...
      updated: 'Penyelesaian bank berhasil diperbarui.',
      deleted: 'Penyelesaian bank berhasil dihapus.',
      notFound: 'Penyelesaian bank tidak ditemukan.',
      notEditable: 'Penyelesaian bank yang sudah selesai tidak dapat diubah lagi.',
      splitCreated:
        'Penyelesaian bank selesai. Baris yang belum ter-tag dipindahkan ke draf baru {no}.',
    },
  },
  arClearings: {
    title: 'Pelunasan Piutang',
    addArClearing: 'Tambah Pelunasan Piutang',
    viewArClearing: 'Detail Pelunasan Piutang',
    codeMode: {
      auto: 'Otomatis',
      manual: 'Manual',
      assignedOnSave: 'Diberikan saat disimpan',
    ...
    fields: {
      no: 'No. Pelunasan',
      branch: 'Cabang',
      clearingDate: 'Tanggal Pelunasan',
      customer: 'Pelanggan',
      selectCustomer: 'Pilih pelanggan',
      customerHint:
        'Mengganti pelanggan akan menghapus kas yang dicentang dan semua alokasi di bawah.',
      remark: 'Catatan',
    },
    sections: {
      header: 'Informasi Pelunasan',
      sources: 'Kas Tersedia',
    ...
    sources: {
      ...
      remaining: 'Sisa',
      consumed: 'Teralokasi',
      empty: 'Pelanggan ini tidak memiliki kas yang belum teralokasi.',
    ...
    invoices: {
      selectCustomerFirst: 'Pilih pelanggan untuk melihat invoice outstanding.',
      invoiceNo: 'Invoice',
      age: 'Umur',
      ageDays: '{days} hari',
      aging: {
        ok: 'Hingga 14 hari',
        warn: '15 sampai 59 hari',
        danger: '60 hari atau lebih',
      },
      total: 'Total',
      outstanding: 'Outstanding',
      outstandingNow: 'Outstanding Saat Ini',
      allocation: 'Alokasi',
      empty: 'Pelanggan ini tidak memiliki invoice outstanding.',
      autoAllocate: 'Auto-alokasi FIFO',
    },
    allocation: {
      none: 'Belum dialokasi',
      partial: 'Sebagian',
      full: 'Lunas',
    },
    summary: {
      available: 'Total Kas Tersedia',
      allocated: 'Total Dialokasikan',
      unallocated: 'Belum Dialokasikan',
      remainderHint:
        'Tidak harus dialokasikan seluruhnya. Sisanya tetap tersedia untuk pelunasan berikutnya pelanggan ini.',
    },
    status: {
      draft: 'Draf',
      completed: 'Selesai',
    ...
    actions: {
      ...
      submit: 'Submit Pelunasan',
      void: 'Batalkan',
      editArClearing: 'Ubah Pelunasan Piutang',
    },
    confirm: {
      header: 'Konfirmasi',
      submit:
        'Terapkan {total} ke invoice {customer}? Pelunasan yang sudah selesai hanya bisa dibatalkan, tidak bisa diubah.',
      autoAllocate: 'Ini akan mengganti alokasi yang sudah Anda isi. Lanjutkan?',
      void: 'Pembatalan mengembalikan setiap invoice dan baris kas yang dialokasikan pelunasan ini. Tindakan ini tidak dapat diurungkan.',
    },
    void: {
      title: 'Batalkan Pelunasan Piutang',
      reason: 'Alasan',
      reasonRequired: 'Alasan wajib diisi untuk membatalkan.',
      voidedBanner: 'Pelunasan ini sudah dibatalkan.',
    },
    validation: {
      noRequired: 'No. pelunasan wajib diisi.',
      customerRequired: 'Pelanggan wajib diisi.',
      branchRequired: 'Cabang wajib diisi.',
      clearingDateRequired: 'Tanggal pelunasan wajib diisi.',
      noSources: 'Centang minimal satu baris kas.',
      noAllocations: 'Alokasikan nominal ke minimal satu invoice.',
      insufficientCash:
        'Total alokasi melebihi kas yang tersedia. Kurangi alokasi atau centang kas lain.',
    },
    messages: {
      created: 'Pelunasan piutang berhasil disimpan.',
      updated: 'Pelunasan piutang berhasil diperbarui.',
      deleted: 'Pelunasan piutang berhasil dihapus.',
      voided: 'Pelunasan piutang berhasil dibatalkan.',
      notFound: 'Pelunasan piutang tidak ditemukan.',
  ...
  deliveryNotes: {
    ...
    addedDos: {
      ...
      summaryDo: '{count} DO',
      summaryCustomers: '{count} pelanggan',
  ...
  invoices: {
    ...
    fields: {
      ...
      tax: 'Pajak',
      total: 'Total',
      headerDiscounts: 'Diskon Pesanan',
      promotionDiscounts: 'Diskon Promosi',
      manualDiscounts: 'Diskon Manual',
      promotionCode: 'Kode',
      discountType: 'Tipe',
      discountValue: 'Nilai',
      discountAmount: 'Jumlah',
