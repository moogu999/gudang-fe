...
export default {
  ...
  bankSettlements: {
    ...
    table: {
      ...
      nameMismatchHint:
        'Nama pengirim di rekening sering berbeda dari nama outlet atau pemilik yang terdaftar. Tag setiap baris berdasarkan outlet yang Anda kenali, bukan dari nama saja.',
    },
    summary: {
