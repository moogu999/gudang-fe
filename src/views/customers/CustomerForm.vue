<template>
  <div class="flex gap-6">
    ...
    <SectionAnchorNav :sections="navSections" />
            ...
            <div class="px-4 pb-4 sm:px-6 sm:pb-6">
              ...
              <div class="mt-4 flex flex-col gap-2 md:flex-row md:items-start md:gap-4">
                ...
                <InfiniteSelect
                  ...
                  @update:model-value="formData.areaId = typeof $event === 'number' ? $event : null"
                />
              </div>
              ...
              <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div class="flex flex-col gap-2">
                  <label class="text-sm font-semibold">{{ t('customers.fields.latitude') }}</label>
                  <InputText v-model="formData.latitude" :disabled="disabled" class="w-full" />
                </div>
                <div class="flex flex-col gap-2">
                  <label class="text-sm font-semibold">{{ t('customers.fields.longitude') }}</label>
              ...
              <template v-if="formData.taxable">
                ...
                <div class="flex flex-col gap-2 md:flex-row md:items-start md:gap-4">
                  ...
                  <div class="flex w-full flex-col gap-1">
                    ...
                    <small v-if="errors.nikOwner" class="text-red-500">{{ errors.nikOwner }}</small>
                  </div>
                </div>
                ...
                <div class="flex flex-col gap-2 md:flex-row md:items-start md:gap-4">
                  ...
                  <div class="flex w-full flex-col gap-1">
                    ...
                    <small v-if="errors.npwpName" class="text-red-500">{{ errors.npwpName }}</small>
                  </div>
                </div>
...
import SectionAnchorNav from './components/SectionAnchorNav.vue'
...
async function onSubmit() {
  ...
  if (!validateFull()) {
    ...
    if (firstErrKey) {
      ...
      const sectionId = sectionMap[firstErrKey] ?? 'identity'
...
const navSections = computed(() => [
  { id: 'identity', label: t('customers.sections.identity') },
  { id: 'location', label: t('customers.sections.location') },
  { id: 'ship-to', label: t('customers.sections.shipTo') },
  { id: 'contact', label: t('customers.sections.contact') },
  { id: 'tax', label: t('customers.sections.tax') },
  { id: 'banking', label: t('customers.sections.banking') },
  { id: 'operational', label: t('customers.sections.operational') },
])
