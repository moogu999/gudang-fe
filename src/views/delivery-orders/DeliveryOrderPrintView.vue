<template>
  <div class="page-bg">
    ...
    <div v-else-if="!detail" class="dm" style="text-align:center;padding:40px">Data tidak ditemukan.</div>
    ...
    <div v-else class="paper">
      ...
      <div class="hdr-grid" style="margin-bottom:6px">
        <div>
          ...
          <div v-if="detail.companyTaxId" class="dm dm-sm faint">NPWP: {{ detail.companyTaxId }}</div>
        </div>
      ...
      <div class="outlet-grid" style="margin: 5px 0 6px">
        ...
        <div>
          <table style="font-family:'Courier New',Courier,monospace;font-size:13px;line-height:1.6;width:100%">
            <tbody>
              <tr>
        ...
        <div style="display:flex;flex-direction:column;gap:6px">
          ...
          <div class="sign-grid" style="margin-top:4px">
            ...
            <div class="sign-box">
              ...
              <div v-if="detail.salesmanName" class="dm center faint" style="font-size:11px;margin-top:2px">{{ detail.salesmanName }}</div>
            </div>
            <div class="sign-box">
              <div class="dm dm-sm center">Diterima oleh,</div>
              <div class="sign-line">Penerima / Cap Toko</div>
              <div class="dm center faint" style="font-size:11px;margin-top:2px">Tgl: ___/___/{{ currentYear }}</div>
            </div>
          </div>
        </div>
        ...
        <div>
          <table class="tot-tbl">
            <tbody>
              ...
              <tr>
                <td style="color:#888">DPP</td>
                <td>{{ formatAmount(detail.dppAmount) }}</td>
              </tr>
              <tr>
      ...
      <div class="dm dm-sm faint">
        Dicetak: Gudang DMS &nbsp;|&nbsp; {{ printTimestamp }}
      </div>
...
.dm-sm { font-size: 11.5px; }
.dm-lg { font-size: 15px; }
...
hr.sep  { border: none; border-top: 1px dashed #999; margin: 5px 0; }
hr.sep2 { border: none; border-top: 2px solid #1A1A18; margin: 5px 0; }
hr.sep3 { border: none; border-top: 1px solid #1A1A18; margin: 3px 0; }
...
.tbl td { padding: 1px 6px; vertical-align: top; }
.tbl .r { text-align: right; }
.tbl .c { text-align: center; }
.tbl tfoot td { border-top: 1px solid #1A1A18; font-weight: 700; padding-top: 3px; }
...
.sign-box { padding: 0 8px; border-right: 1px dashed #bbb; }
.sign-box:first-child { padding-left: 0; }
.sign-box:last-child  { padding-right: 0; border-right: none; }
...
.tot-tbl { width: 100%; font-family: 'Courier New', Courier, monospace; font-size: 13px; line-height: 1.6; }
.tot-tbl td:last-child { text-align: right; font-variant-numeric: tabular-nums; }
.tot-tbl .grand td { border-top: 1.5px solid #1A1A18; font-weight: 700; font-size: 14px; padding-top: 3px; }

@media print {
  .page-bg { background: white; padding: 0; min-height: 0; }
  .paper {
    box-shadow: none;
    width: 100%;
    min-height: auto;
