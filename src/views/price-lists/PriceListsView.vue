        ...
        <TableComponent ref="table" :url="url" :columns="columns">
          <template #content="{ col, data }">
            ...
            <TableActionButtons
              v-if="col.field === ''"
              :can-write="canWrite"
              @view="router.push(`/price-lists/${data['id']}`)"
              @edit="router.push(`/price-lists/${data['id']}/edit`)"
...
const overlayGroup = 'priceListsView'
const { canWrite } = usePermissions('/price-lists')
const table = ref()
...
function onDeleteClick(id: number) {
  confirmDelete(() => PriceListsService.delete(id))
}
</script>
